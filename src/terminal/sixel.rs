...
use picto::color::{Hsl, RgbHue, Rgba};
use sys::cairo;
...
impl Sixel {
    ...
    pub fn define(&mut self, id: u32, color: SIXEL::Color) {
        let color = match color {
            SIXEL::Color::Hsl(h, s, l) => Rgba::from(Hsl::new(
                RgbHue::from_radians(h as f32 * f32::consts::PI / 180.0),
                s as f32 / 100.0,
                l as f32 / 100.0,
            ))
            .to_pixel(),

            SIXEL::Color::Rgb(r, g, b) => (r, g, b, 255),

            SIXEL::Color::Rgba(r, g, b, a) => (r, g, b, a),
        };
    ...
    pub fn draw(&mut self, times: u32, value: SIXEL::Map) {
        ...
        for _ in 0..times {
            ...
            for (i, y) in
                (self.position.1..self.position.1 + (6 * self.raster.aspect.0)).enumerate()
            {
